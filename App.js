...
const API = "https://content.newtonschool.co/v1/pr/64806cf8b7d605c99eecde47/news"
   ...
   data.forEach((e)=>{
    ...
    ` <div class="newsdiv">
                <div class="name-category">
                    <p class="name">BY: <b class="nametext">${e[" author"].toUpperCase()}</b></p>
                    <p class="category">CATEGORY: <b class="category-text">${e[" category"].toUpperCase()}</b></p>
                </div>
                <div>
                    <span class="content">${e.content}</span>
                    <button class="readmore"><a href="${e.url}" class="ancread" target="_blank">READ MORE</a></button>
                </div>
                <div class="icon">
                    <i id="${e[" category"]}" class="fa-sharp fa-regular fa-heart fa-2xl fav-icon"></i>
                </div>
            </div>`
...
{  
  console.log("hons")
    ...
    ` <div class="newsdiv">
                ...
                <div class="icon">
                    <i  id="${e[" category"]}"class="fa-solid  fa-regular fa-heart fa-2xl fav-icon"></i>
                </div>
            </div>`
       newsdiv2.innerHTML += html     
}
